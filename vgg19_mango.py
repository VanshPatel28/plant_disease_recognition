...
callbacks = [
    ...
    ModelCheckpoint('vgg19_mango_best.keras', monitor='val_accuracy', save_best_only=True, verbose=1),
...
# ─────────────────────────────────────────────
# PHASE 2: Fine-tune last 4 conv layers of VGG19
# ─────────────────────────────────────────────
...
plt.tight_layout()
plt.savefig('vgg19_training_curves.png', dpi=150)
plt.show()
...
print("\nModel saved as: vgg19_mango_best.keras")
print("Plots saved as: vgg19_training_curves.png, vgg19_confusion_matrix.png")
